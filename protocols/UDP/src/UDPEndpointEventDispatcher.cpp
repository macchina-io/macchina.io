...
UDPEndpointEventDispatcher::UDPEndpointEventDispatcher(IUDPEndpoint* pInterface, const Poco::RemotingNG::Identifiable::ObjectId& objectId, const std::string& protocol):
	Poco::RemotingNG::EventDispatcher(protocol),
	_objectId(objectId),
	_pInterface(pInterface)
{
	_pInterface->packetReceived += Poco::delegate(this, &UDPEndpointEventDispatcher::event__packetReceived);
}
