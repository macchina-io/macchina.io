...
public:
	...
	static void serializeImpl(const IoT::MQTT::Message& value, Serializer& ser)
	{
		...
		static const std::string REMOTING__NAMES[] = {"payload"s,"binaryPayload"s,"qos"s,"retained"s,"properties"s,""s};
		TypeSerializer<std::string>::serialize(REMOTING__NAMES[0], value.payload, ser);
		TypeSerializer<std::vector<char>>::serialize(REMOTING__NAMES[1], value.binaryPayload, ser);
		...
		TypeSerializer<std::vector<IoT::MQTT::Property>>::serialize(REMOTING__NAMES[4], value.properties, ser);
	}
