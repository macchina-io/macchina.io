//
// ReadDiscreteInputsRequestDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_IoT_Modbus_ReadDiscreteInputsRequest_INCLUDED
#define TypeDeserializer_IoT_Modbus_ReadDiscreteInputsRequest_INCLUDED
...
template <>
class TypeDeserializer<IoT::Modbus::ReadDiscreteInputsRequest>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, IoT::Modbus::ReadDiscreteInputsRequest& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, IoT::Modbus::ReadDiscreteInputsRequest& value)
	{
		using namespace std::string_literals;
		...
		static const std::string REMOTING__NAMES[] = {"nOfInputs"s,"startingAddress"s};
		TypeDeserializer<Poco::UInt16 >::deserialize(REMOTING__NAMES[0], true, deser, value.nOfInputs);
...
#endif // TypeDeserializer_IoT_Modbus_ReadDiscreteInputsRequest_INCLUDED
