//
// ReadCoilsRequestDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_IoT_Modbus_ReadCoilsRequest_INCLUDED
#define TypeDeserializer_IoT_Modbus_ReadCoilsRequest_INCLUDED
...
template <>
class TypeDeserializer<IoT::Modbus::ReadCoilsRequest>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, IoT::Modbus::ReadCoilsRequest& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, IoT::Modbus::ReadCoilsRequest& value)
	{
		using namespace std::string_literals;
...
#endif // TypeDeserializer_IoT_Modbus_ReadCoilsRequest_INCLUDED
