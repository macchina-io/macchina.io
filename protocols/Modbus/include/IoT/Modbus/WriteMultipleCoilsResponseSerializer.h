//
// WriteMultipleCoilsResponseSerializer.h
//
// Package: Generated
...
#ifndef TypeSerializer_IoT_Modbus_WriteMultipleCoilsResponse_INCLUDED
#define TypeSerializer_IoT_Modbus_WriteMultipleCoilsResponse_INCLUDED
...
template <>
class TypeSerializer<IoT::Modbus::WriteMultipleCoilsResponse>
{
public:
	static void serialize(const std::string& name, const IoT::Modbus::WriteMultipleCoilsResponse& value, Serializer& ser)
	{
	...
	static void serializeImpl(const IoT::Modbus::WriteMultipleCoilsResponse& value, Serializer& ser)
	{
		using namespace std::string_literals;
		...
		static const std::string REMOTING__NAMES[] = {"nOfCoils"s,"startingAddress"s,""s};
...
#endif // TypeSerializer_IoT_Modbus_WriteMultipleCoilsResponse_INCLUDED
