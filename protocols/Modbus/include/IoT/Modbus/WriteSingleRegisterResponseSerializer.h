//
// WriteSingleRegisterResponseSerializer.h
//
// Package: Generated
...
#ifndef TypeSerializer_IoT_Modbus_WriteSingleRegisterResponse_INCLUDED
#define TypeSerializer_IoT_Modbus_WriteSingleRegisterResponse_INCLUDED
...
template <>
class TypeSerializer<IoT::Modbus::WriteSingleRegisterResponse>
{
public:
	static void serialize(const std::string& name, const IoT::Modbus::WriteSingleRegisterResponse& value, Serializer& ser)
	{
	...
	static void serializeImpl(const IoT::Modbus::WriteSingleRegisterResponse& value, Serializer& ser)
	{
...
#endif // TypeSerializer_IoT_Modbus_WriteSingleRegisterResponse_INCLUDED
