//
// ReadExceptionStatusResponseDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_IoT_Modbus_ReadExceptionStatusResponse_INCLUDED
#define TypeDeserializer_IoT_Modbus_ReadExceptionStatusResponse_INCLUDED
...
template <>
class TypeDeserializer<IoT::Modbus::ReadExceptionStatusResponse>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, IoT::Modbus::ReadExceptionStatusResponse& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, IoT::Modbus::ReadExceptionStatusResponse& value)
	{
		...
		TypeDeserializer<Poco::UInt8 >::deserialize(REMOTING__NAMES[0], true, deser, value.data);
	}
...
#endif // TypeDeserializer_IoT_Modbus_ReadExceptionStatusResponse_INCLUDED
