...
#ifndef IoT_Modbus_ModbusMasterStub_INCLUDED
#define IoT_Modbus_ModbusMasterStub_INCLUDED
...
class ModbusMasterStub: public IoT::Modbus::ModbusMasterRemoteObject
...
{
public:
	typedef Poco::AutoPtr<ModbusMasterStub> Ptr;

	ModbusMasterStub(const Poco::RemotingNG::Identifiable::ObjectId& oid, Poco::SharedPtr<IoT::Modbus::ModbusMaster> pServiceObject);
		/// Creates a ModbusMasterStub.

	virtual ~ModbusMasterStub();
		/// Destroys the ModbusMasterStub.
...
inline void ModbusMasterStub::maskWriteRegister(Poco::UInt8 slaveAddress, Poco::UInt16 outputAddress, Poco::UInt16 andMask, Poco::UInt16 orMask)
{
	_pServiceObject->maskWriteRegister(slaveAddress, outputAddress, andMask, orMask);
}


inline std::vector < bool > ModbusMasterStub::readCoils(Poco::UInt8 slaveAddress, Poco::UInt16 startingAddress, Poco::UInt16 nOfCoils)
{
	return _pServiceObject->readCoils(slaveAddress, startingAddress, nOfCoils);
}


inline std::vector < bool > ModbusMasterStub::readDiscreteInputs(Poco::UInt8 slaveAddress, Poco::UInt16 startingAddress, Poco::UInt16 nOfInputs)
{
	return _pServiceObject->readDiscreteInputs(slaveAddress, startingAddress, nOfInputs);
}


inline Poco::UInt8 ModbusMasterStub::readExceptionStatus(Poco::UInt8 slaveAddress)
{
	return _pServiceObject->readExceptionStatus(slaveAddress);
}


inline std::vector < Poco::UInt16 > ModbusMasterStub::readFIFOQueue(Poco::UInt8 slaveAddress, Poco::UInt16 fifoPointerAddress)
{
	return _pServiceObject->readFIFOQueue(slaveAddress, fifoPointerAddress);
}


inline std::vector < Poco::UInt16 > ModbusMasterStub::readHoldingRegisters(Poco::UInt8 slaveAddress, Poco::UInt16 startingAddress, Poco::UInt16 nOfRegisters)
{
	return _pServiceObject->readHoldingRegisters(slaveAddress, startingAddress, nOfRegisters);
}


inline std::vector < Poco::UInt16 > ModbusMasterStub::readInputRegisters(Poco::UInt8 slaveAddress, Poco::UInt16 startingAddress, Poco::UInt16 nOfRegisters)
{
	return _pServiceObject->readInputRegisters(slaveAddress, startingAddress, nOfRegisters);
}


inline std::vector < Poco::UInt16 > ModbusMasterStub::readWriteMultipleRegisters(Poco::UInt8 slaveAddress, Poco::UInt16 writeStartingAddress, std::vector < Poco::UInt16 > writeValues, Poco::UInt16 readStartingAddress, Poco::UInt8 nOfReadRegisters)
{
...
inline const Poco::RemotingNG::Identifiable::TypeId& ModbusMasterStub::remoting__typeId() const
{
	return IModbusMaster::remoting__typeId();
}


inline Poco::UInt16 ModbusMasterStub::sendMaskWriteRegisterRequest(const IoT::Modbus::MaskWriteRegisterRequest& request)
{
	return _pServiceObject->sendMaskWriteRegisterRequest(request);
}


inline Poco::UInt16 ModbusMasterStub::sendReadCoilsRequest(const IoT::Modbus::ReadCoilsRequest& request)
{
	return _pServiceObject->sendReadCoilsRequest(request);
}


inline Poco::UInt16 ModbusMasterStub::sendReadDiscreteInputsRequest(const IoT::Modbus::ReadDiscreteInputsRequest& request)
{
	return _pServiceObject->sendReadDiscreteInputsRequest(request);
}


inline Poco::UInt16 ModbusMasterStub::sendReadExceptionStatusRequest(const IoT::Modbus::ReadExceptionStatusRequest& request)
{
	return _pServiceObject->sendReadExceptionStatusRequest(request);
}


inline Poco::UInt16 ModbusMasterStub::sendReadFIFOQueueRequest(const IoT::Modbus::ReadFIFOQueueRequest& request)
{
	return _pServiceObject->sendReadFIFOQueueRequest(request);
}


inline Poco::UInt16 ModbusMasterStub::sendReadHoldingRegistersRequest(const IoT::Modbus::ReadHoldingRegistersRequest& request)
{
	return _pServiceObject->sendReadHoldingRegistersRequest(request);
}


inline Poco::UInt16 ModbusMasterStub::sendReadInputRegistersRequest(const IoT::Modbus::ReadInputRegistersRequest& request)
{
	return _pServiceObject->sendReadInputRegistersRequest(request);
}


inline Poco::UInt16 ModbusMasterStub::sendReadWriteMultipleRegistersRequest(const IoT::Modbus::ReadWriteMultipleRegistersRequest& request)
{
	return _pServiceObject->sendReadWriteMultipleRegistersRequest(request);
}


inline Poco::UInt16 ModbusMasterStub::sendRequest(const IoT::Modbus::GenericMessage& message)
{
	return _pServiceObject->sendRequest(message);
}


inline Poco::UInt16 ModbusMasterStub::sendWriteMultipleCoilsRequest(const IoT::Modbus::WriteMultipleCoilsRequest& request)
{
	return _pServiceObject->sendWriteMultipleCoilsRequest(request);
}


inline Poco::UInt16 ModbusMasterStub::sendWriteMultipleRegistersRequest(const IoT::Modbus::WriteMultipleRegistersRequest& request)
{
	return _pServiceObject->sendWriteMultipleRegistersRequest(request);
}


inline Poco::UInt16 ModbusMasterStub::sendWriteSingleCoilRequest(const IoT::Modbus::WriteSingleCoilRequest& request)
{
	return _pServiceObject->sendWriteSingleCoilRequest(request);
}


inline Poco::UInt16 ModbusMasterStub::sendWriteSingleRegisterRequest(const IoT::Modbus::WriteSingleRegisterRequest& request)
{
	return _pServiceObject->sendWriteSingleRegisterRequest(request);
}


inline void ModbusMasterStub::writeMultipleCoils(Poco::UInt8 slaveAddress, Poco::UInt16 outputAddress, std::vector < bool > values)
{
	_pServiceObject->writeMultipleCoils(slaveAddress, outputAddress, values);
}


inline void ModbusMasterStub::writeMultipleRegisters(Poco::UInt8 slaveAddress, Poco::UInt16 outputAddress, std::vector < Poco::UInt16 > values)
{
	_pServiceObject->writeMultipleRegisters(slaveAddress, outputAddress, values);
}


inline void ModbusMasterStub::writeSingleCoil(Poco::UInt8 slaveAddress, Poco::UInt16 outputAddress, bool value)
{
	_pServiceObject->writeSingleCoil(slaveAddress, outputAddress, value);
}


inline void ModbusMasterStub::writeSingleRegister(Poco::UInt8 slaveAddress, Poco::UInt16 outputAddress, Poco::UInt16 value)
{
...
#endif // IoT_Modbus_ModbusMasterStub_INCLUDED
