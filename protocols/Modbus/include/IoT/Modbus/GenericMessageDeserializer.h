...
#ifndef TypeDeserializer_IoT_Modbus_GenericMessage_INCLUDED
#define TypeDeserializer_IoT_Modbus_GenericMessage_INCLUDED
...
template <>
class TypeDeserializer<IoT::Modbus::GenericMessage>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, IoT::Modbus::GenericMessage& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, IoT::Modbus::GenericMessage& value)
	{
...
#endif // TypeDeserializer_IoT_Modbus_GenericMessage_INCLUDED
