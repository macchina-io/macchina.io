//
// WriteSingleRegisterRequestSerializer.h
//
// Package: Generated
...
#ifndef TypeSerializer_IoT_Modbus_WriteSingleRegisterRequest_INCLUDED
#define TypeSerializer_IoT_Modbus_WriteSingleRegisterRequest_INCLUDED
...
template <>
class TypeSerializer<IoT::Modbus::WriteSingleRegisterRequest>
{
public:
	static void serialize(const std::string& name, const IoT::Modbus::WriteSingleRegisterRequest& value, Serializer& ser)
	{
	...
	static void serializeImpl(const IoT::Modbus::WriteSingleRegisterRequest& value, Serializer& ser)
	{
...
#endif // TypeSerializer_IoT_Modbus_WriteSingleRegisterRequest_INCLUDED
