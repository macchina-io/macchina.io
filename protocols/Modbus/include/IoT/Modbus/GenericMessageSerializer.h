...
#ifndef TypeSerializer_IoT_Modbus_GenericMessage_INCLUDED
#define TypeSerializer_IoT_Modbus_GenericMessage_INCLUDED
...
template <>
class TypeSerializer<IoT::Modbus::GenericMessage>
{
public:
	static void serialize(const std::string& name, const IoT::Modbus::GenericMessage& value, Serializer& ser)
	{
	...
	static void serializeImpl(const IoT::Modbus::GenericMessage& value, Serializer& ser)
	{
...
#endif // TypeSerializer_IoT_Modbus_GenericMessage_INCLUDED
