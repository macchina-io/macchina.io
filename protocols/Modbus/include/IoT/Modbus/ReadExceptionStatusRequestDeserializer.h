//
// ReadExceptionStatusRequestDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_IoT_Modbus_ReadExceptionStatusRequest_INCLUDED
#define TypeDeserializer_IoT_Modbus_ReadExceptionStatusRequest_INCLUDED
...
template <>
class TypeDeserializer<IoT::Modbus::ReadExceptionStatusRequest>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, IoT::Modbus::ReadExceptionStatusRequest& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, IoT::Modbus::ReadExceptionStatusRequest& value)
	{
...
#endif // TypeDeserializer_IoT_Modbus_ReadExceptionStatusRequest_INCLUDED
