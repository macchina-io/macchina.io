//
// ReadWriteMultipleRegistersResponseDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_IoT_Modbus_ReadWriteMultipleRegistersResponse_INCLUDED
#define TypeDeserializer_IoT_Modbus_ReadWriteMultipleRegistersResponse_INCLUDED
...
template <>
class TypeDeserializer<IoT::Modbus::ReadWriteMultipleRegistersResponse>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, IoT::Modbus::ReadWriteMultipleRegistersResponse& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, IoT::Modbus::ReadWriteMultipleRegistersResponse& value)
	{
		using namespace std::string_literals;
		...
		static const std::string REMOTING__NAMES[] = {"values"s};
...
#endif // TypeDeserializer_IoT_Modbus_ReadWriteMultipleRegistersResponse_INCLUDED
