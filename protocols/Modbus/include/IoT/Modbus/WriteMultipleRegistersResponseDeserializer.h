//
// WriteMultipleRegistersResponseDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_IoT_Modbus_WriteMultipleRegistersResponse_INCLUDED
#define TypeDeserializer_IoT_Modbus_WriteMultipleRegistersResponse_INCLUDED
...
template <>
class TypeDeserializer<IoT::Modbus::WriteMultipleRegistersResponse>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, IoT::Modbus::WriteMultipleRegistersResponse& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, IoT::Modbus::WriteMultipleRegistersResponse& value)
	{
		using namespace std::string_literals;
		...
		static const std::string REMOTING__NAMES[] = {"nOfRegisters"s,"startingAddress"s};
...
#endif // TypeDeserializer_IoT_Modbus_WriteMultipleRegistersResponse_INCLUDED
