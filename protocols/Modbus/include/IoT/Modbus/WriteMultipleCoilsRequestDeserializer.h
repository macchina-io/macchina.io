//
// WriteMultipleCoilsRequestDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_IoT_Modbus_WriteMultipleCoilsRequest_INCLUDED
#define TypeDeserializer_IoT_Modbus_WriteMultipleCoilsRequest_INCLUDED
...
template <>
class TypeDeserializer<IoT::Modbus::WriteMultipleCoilsRequest>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, IoT::Modbus::WriteMultipleCoilsRequest& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, IoT::Modbus::WriteMultipleCoilsRequest& value)
	{
		using namespace std::string_literals;
		...
		TypeDeserializer<std::vector < bool > >::deserialize(REMOTING__NAMES[1], true, deser, value.values);
	}
...
#endif // TypeDeserializer_IoT_Modbus_WriteMultipleCoilsRequest_INCLUDED
