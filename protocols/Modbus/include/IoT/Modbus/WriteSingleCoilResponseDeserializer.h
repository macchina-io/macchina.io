//
// WriteSingleCoilResponseDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_IoT_Modbus_WriteSingleCoilResponse_INCLUDED
#define TypeDeserializer_IoT_Modbus_WriteSingleCoilResponse_INCLUDED
...
template <>
class TypeDeserializer<IoT::Modbus::WriteSingleCoilResponse>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, IoT::Modbus::WriteSingleCoilResponse& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, IoT::Modbus::WriteSingleCoilResponse& value)
	{
...
#endif // TypeDeserializer_IoT_Modbus_WriteSingleCoilResponse_INCLUDED
