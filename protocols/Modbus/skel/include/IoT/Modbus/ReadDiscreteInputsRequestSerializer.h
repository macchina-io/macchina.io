//
// ReadDiscreteInputsRequestSerializer.h
//
// Package: Generated
...
#ifndef TypeSerializer_IoT_Modbus_ReadDiscreteInputsRequest_INCLUDED
#define TypeSerializer_IoT_Modbus_ReadDiscreteInputsRequest_INCLUDED
...
template <>
class TypeSerializer<IoT::Modbus::ReadDiscreteInputsRequest>
{
public:
	static void serialize(const std::string& name, const IoT::Modbus::ReadDiscreteInputsRequest& value, Serializer& ser)
	{
	...
	static void serializeImpl(const IoT::Modbus::ReadDiscreteInputsRequest& value, Serializer& ser)
	{
		using namespace std::string_literals;
		...
		static const std::string REMOTING__NAMES[] = {"startingAddress"s,"nOfInputs"s,""s};
		TypeSerializer<Poco::UInt16>::serialize(REMOTING__NAMES[0], value.startingAddress, ser);
		TypeSerializer<Poco::UInt16>::serialize(REMOTING__NAMES[1], value.nOfInputs, ser);
	}
...
#endif // TypeSerializer_IoT_Modbus_ReadDiscreteInputsRequest_INCLUDED
