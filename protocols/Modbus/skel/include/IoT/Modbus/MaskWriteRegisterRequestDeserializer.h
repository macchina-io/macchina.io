//
// MaskWriteRegisterRequestDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_IoT_Modbus_MaskWriteRegisterRequest_INCLUDED
#define TypeDeserializer_IoT_Modbus_MaskWriteRegisterRequest_INCLUDED
...
template <>
class TypeDeserializer<IoT::Modbus::MaskWriteRegisterRequest>
{
public:
	...
	static void deserializeImpl(Deserializer& deser, IoT::Modbus::MaskWriteRegisterRequest& value)
	{
		...
		static const std::string REMOTING__NAMES[] = {"referenceAddress"s,"andMask"s,"orMask"s};
		TypeDeserializer<Poco::UInt16>::deserialize(REMOTING__NAMES[0], true, deser, value.referenceAddress);
		TypeDeserializer<Poco::UInt16>::deserialize(REMOTING__NAMES[1], true, deser, value.andMask);
		TypeDeserializer<Poco::UInt16>::deserialize(REMOTING__NAMES[2], true, deser, value.orMask);
	}
...
#endif // TypeDeserializer_IoT_Modbus_MaskWriteRegisterRequest_INCLUDED
