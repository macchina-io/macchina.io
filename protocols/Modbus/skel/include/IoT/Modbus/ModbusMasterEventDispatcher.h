...
public:
	...
	void event__connectionStateChanged(const void* pSender, const IoT::Modbus::ConnectionState& data);
	...
	void event__requestFailed(const void* pSender, const IoT::Modbus::RequestFailure& data);
...
private:
	...
	void event__connectionStateChangedImpl(const std::string& subscriberURI, const IoT::Modbus::ConnectionState& data);
	...
	void event__requestFailedImpl(const std::string& subscriberURI, const IoT::Modbus::RequestFailure& data);
