//
// WriteMultipleCoilsResponseDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_IoT_Modbus_WriteMultipleCoilsResponse_INCLUDED
#define TypeDeserializer_IoT_Modbus_WriteMultipleCoilsResponse_INCLUDED
...
template <>
class TypeDeserializer<IoT::Modbus::WriteMultipleCoilsResponse>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, IoT::Modbus::WriteMultipleCoilsResponse& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, IoT::Modbus::WriteMultipleCoilsResponse& value)
	{
		using namespace std::string_literals;
		...
		static const std::string REMOTING__NAMES[] = {"nOfCoils"s,"startingAddress"s};
		TypeDeserializer<Poco::UInt16 >::deserialize(REMOTING__NAMES[0], true, deser, value.nOfCoils);
...
#endif // TypeDeserializer_IoT_Modbus_WriteMultipleCoilsResponse_INCLUDED
