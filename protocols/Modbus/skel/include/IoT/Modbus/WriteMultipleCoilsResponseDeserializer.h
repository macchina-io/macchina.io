...
public:
	...
	static void deserializeImpl(Deserializer& deser, IoT::Modbus::WriteMultipleCoilsResponse& value)
	{
		...
		static const std::string REMOTING__NAMES[] = {"startingAddress"s,"nOfCoils"s};
		TypeDeserializer<Poco::UInt16>::deserialize(REMOTING__NAMES[0], true, deser, value.startingAddress);
		TypeDeserializer<Poco::UInt16>::deserialize(REMOTING__NAMES[1], true, deser, value.nOfCoils);
	}
