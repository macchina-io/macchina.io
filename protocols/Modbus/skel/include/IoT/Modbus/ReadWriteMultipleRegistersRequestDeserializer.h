...
public:
	...
	static void deserializeImpl(Deserializer& deser, IoT::Modbus::ReadWriteMultipleRegistersRequest& value)
	{
		...
		static const std::string REMOTING__NAMES[] = {"readStartingAddress"s,"readCount"s,"writeStartingAddress"s,"values"s};
		TypeDeserializer<Poco::UInt16>::deserialize(REMOTING__NAMES[0], true, deser, value.readStartingAddress);
		TypeDeserializer<Poco::UInt16>::deserialize(REMOTING__NAMES[1], true, deser, value.readCount);
		TypeDeserializer<Poco::UInt16>::deserialize(REMOTING__NAMES[2], true, deser, value.writeStartingAddress);
		TypeDeserializer<std::vector<Poco::UInt16>>::deserialize(REMOTING__NAMES[3], true, deser, value.values);
	}
