...
public:
	...
	static void serializeImpl(const IoT::XBee::ZigBeeTransmitRequest& value, Serializer& ser)
	{
		...
		static const std::string REMOTING__NAMES[] = {"frameID"s,"deviceAddress"s,"networkAddress"s,"broadcastRadius"s,"options"s,"payload"s,""s};
		...
		TypeSerializer<Poco::UInt8>::serialize(REMOTING__NAMES[3], value.broadcastRadius, ser);
