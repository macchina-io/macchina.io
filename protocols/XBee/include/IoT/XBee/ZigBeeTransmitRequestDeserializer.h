...
public:
	...
	static void deserializeImpl(Deserializer& deser, IoT::XBee::ZigBeeTransmitRequest& value)
	{
		...
		static const std::string REMOTING__NAMES[] = {"frameID"s,"deviceAddress"s,"networkAddress"s,"broadcastRadius"s,"options"s,"payload"s};
		...
		TypeDeserializer<Poco::UInt8>::deserialize(REMOTING__NAMES[3], true, deser, value.broadcastRadius);
