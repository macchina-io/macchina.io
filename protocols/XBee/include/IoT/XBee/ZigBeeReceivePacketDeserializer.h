//
// ZigBeeReceivePacketDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_IoT_XBee_ZigBeeReceivePacket_INCLUDED
#define TypeDeserializer_IoT_XBee_ZigBeeReceivePacket_INCLUDED
...
template <>
class TypeDeserializer<IoT::XBee::ZigBeeReceivePacket>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, IoT::XBee::ZigBeeReceivePacket& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, IoT::XBee::ZigBeeReceivePacket& value)
	{
...
#endif // TypeDeserializer_IoT_XBee_ZigBeeReceivePacket_INCLUDED
