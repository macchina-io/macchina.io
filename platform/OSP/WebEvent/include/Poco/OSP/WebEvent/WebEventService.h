...
// WebEventService.h
//
// $Id: //poco/1.4/OSP/WebEvent/include/Poco/OSP/WebEvent/WebEventService.h#7 $
//
...
{
public:
	typedef Poco::AutoPtr<WebEventService> Ptr;
	typedef std::pair<std::string, std::string> NotificationEvent;
