...
macro(create_bundle)
  ...
  add_custom_command(TARGET ${CREATE_BUNDLE_TARGET} POST_BUILD
	COMMAND LD_LIBRARY_PATH=${CMAKE_BINARY_DIR}/lib/${CMAKE_SYSTEM_NAME}/${CMAKE_SYSTEM_PROCESSOR}:${POCOCPP_ROOT}/lib:${POCOCPP_ROOT}/lib/${CMAKE_SYSTEM_NAME}/${CMAKE_SYSTEM_PROCESSOR} $<TARGET_FILE:Poco::bundle> -n${CMAKE_SYSTEM_NAME} -a${CMAKE_SYSTEM_PROCESSOR} -o${CMAKE_BINARY_DIR}/bundles ${CMAKE_CURRENT_SOURCE_DIR}/${CREATE_BUNDLE_SPEC_FILE}
