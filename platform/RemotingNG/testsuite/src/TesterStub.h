...
inline void TesterStub::fireTestFilteredEvent(int arg)
{
...
inline void TesterStub::testArgNamespace(const Struct3& s31, Struct3& s32)
{
...
inline void TesterStub::testPermission1()
{
	_pServiceObject->testPermission1();
}


inline void TesterStub::testPermission2()
{
