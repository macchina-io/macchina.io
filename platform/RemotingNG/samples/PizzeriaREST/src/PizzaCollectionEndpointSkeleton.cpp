//
// PizzaCollectionEndpointSkeleton.cpp
//
// Package: Generated
...
class PizzaCollectionEndpointGetMethodHandler: public Poco::RemotingNG::MethodHandler
{
public:
	void invoke(Poco::RemotingNG::ServerTransport& remoting__trans, Poco::RemotingNG::Deserializer& remoting__deser, Poco::RemotingNG::RemoteObject::Ptr remoting__pRemoteObject)
	{
		...
		try
		{
			...
			Pizzeria::PizzaCollectionEndpointRemoteObject* remoting__pCastedRO = static_cast<Pizzeria::PizzaCollectionEndpointRemoteObject*>(remoting__pRemoteObject.get());
...
PizzaCollectionEndpointSkeleton::PizzaCollectionEndpointSkeleton():
...
const std::string PizzaCollectionEndpointSkeleton::DEFAULT_NS("");
} // namespace Pizzeria
