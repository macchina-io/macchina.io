...
public:
	void invoke(Poco::RemotingNG::ServerTransport& remoting__trans, Poco::RemotingNG::Deserializer& remoting__deser, Poco::RemotingNG::RemoteObject::Ptr remoting__pRemoteObject)
	{
		...
		try
		{
			...
			Pizzeria::PizzaDeliveryServiceRemoteObject* remoting__pCastedRO = dynamic_cast<Pizzeria::PizzaDeliveryServiceRemoteObject*>(remoting__pRemoteObject.get());
...
{
	addMethodHandler("getAnyPizza", new Pizzeria::PizzaDeliveryServiceGetAnyPizzaMethodHandler);
	addMethodHandler("getMostPopularTopping", new Pizzeria::PizzaDeliveryServiceGetMostPopularToppingMethodHandler);
	addMethodHandler("getPizzaNames", new Pizzeria::PizzaDeliveryServiceGetPizzaNamesMethodHandler);
	addMethodHandler("getPizzas", new Pizzeria::PizzaDeliveryServiceGetPizzasMethodHandler);
	addMethodHandler("getToppings", new Pizzeria::PizzaDeliveryServiceGetToppingsMethodHandler);
	addMethodHandler("getWaitTime", new Pizzeria::PizzaDeliveryServiceGetWaitTimeMethodHandler);
	addMethodHandler("order", new Pizzeria::PizzaDeliveryServiceOrderMethodHandler);
}
