...
//
// $Id: //poco/1.4/RemotingNG/RemoteGen/src/EventSubscriberGenerator.cpp#7 $
//
...
void EventSubscriberGenerator::checkForEventMembers(const Poco::CppParser::Struct* pStruct)
{
	bool events = false;
