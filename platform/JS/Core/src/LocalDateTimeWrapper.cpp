...
v8::Handle<v8::ObjectTemplate> LocalDateTimeWrapper::objectTemplate(v8::Isolate* pIsolate)
{
	...
	if (pooledObjectTemplate.IsEmpty())
	{
		...
		objectTemplate->SetAccessor(toV8String(pIsolate, "year"s), year);
		objectTemplate->SetAccessor(toV8String(pIsolate, "month"s), month);
		objectTemplate->SetAccessor(toV8String(pIsolate, "day"s), day);
		objectTemplate->SetAccessor(toV8String(pIsolate, "hour"s), hour);
		objectTemplate->SetAccessor(toV8String(pIsolate, "hour12"s), hourAMPM);
		objectTemplate->SetAccessor(toV8String(pIsolate, "am"s), isAM);
		objectTemplate->SetAccessor(toV8String(pIsolate, "pm"s), isPM);
		objectTemplate->SetAccessor(toV8String(pIsolate, "minute"s), minute);
		objectTemplate->SetAccessor(toV8String(pIsolate, "second"s), second);
		objectTemplate->SetAccessor(toV8String(pIsolate, "dayOfWeek"s), dayOfWeek);
		objectTemplate->SetAccessor(toV8String(pIsolate, "dayOfYear"s), dayOfYear);
		objectTemplate->SetAccessor(toV8String(pIsolate, "julian"s), julian);
		objectTemplate->SetAccessor(toV8String(pIsolate, "timestamp"s), timestamp);
		objectTemplate->SetAccessor(toV8String(pIsolate, "epoch"s), epoch);
		objectTemplate->SetAccessor(toV8String(pIsolate, "tzd"s), tzd);

		objectTemplate->Set(toV8String(pIsolate, "daysOfMonth"s), v8::FunctionTemplate::New(pIsolate, daysOfMonth));
		objectTemplate->Set(toV8String(pIsolate, "isLeapYear"s), v8::FunctionTemplate::New(pIsolate, isLeapYear));
		objectTemplate->Set(toV8String(pIsolate, "addSeconds"s), v8::FunctionTemplate::New(pIsolate, addSeconds));
		objectTemplate->Set(toV8String(pIsolate, "addHours"s), v8::FunctionTemplate::New(pIsolate, addHours));
		objectTemplate->Set(toV8String(pIsolate, "addDays"s), v8::FunctionTemplate::New(pIsolate, addDays));
		objectTemplate->Set(toV8String(pIsolate, "utc"s), v8::FunctionTemplate::New(pIsolate, utc));
		objectTemplate->Set(toV8String(pIsolate, "format"s), v8::FunctionTemplate::New(pIsolate, format));
		objectTemplate->Set(toV8String(pIsolate, "toString"s), v8::FunctionTemplate::New(pIsolate, format));
		objectTemplate->Set(toV8String(pIsolate, "toDate"s), v8::FunctionTemplate::New(pIsolate, toDate));
		objectTemplate->Set(toV8String(pIsolate, "toJSON"s), v8::FunctionTemplate::New(pIsolate, toJSON));
