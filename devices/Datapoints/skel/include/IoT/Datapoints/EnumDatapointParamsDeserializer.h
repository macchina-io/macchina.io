//
// EnumDatapointParamsDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_IoT_Datapoints_EnumDatapointParams_INCLUDED
#define TypeDeserializer_IoT_Datapoints_EnumDatapointParams_INCLUDED
...
template <>
class TypeDeserializer<IoT::Datapoints::EnumDatapointParams>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, IoT::Datapoints::EnumDatapointParams& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, IoT::Datapoints::EnumDatapointParams& value)
	{
		using namespace std::string_literals;
		...
		TypeDeserializer<Poco::Optional < int > >::deserialize(REMOTING__NAMES[0], false, deser, value.initialValue);
		TypeDeserializer<std::vector < IoT::Devices::EnumValue > >::deserialize(REMOTING__NAMES[1], true, deser, value.values);
	}
...
#endif // TypeDeserializer_IoT_Datapoints_EnumDatapointParams_INCLUDED
