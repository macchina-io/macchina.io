//
// StringDatapointParamsSerializer.h
//
// Package: Generated
...
#ifndef TypeSerializer_IoT_Datapoints_StringDatapointParams_INCLUDED
#define TypeSerializer_IoT_Datapoints_StringDatapointParams_INCLUDED
...
template <>
class TypeSerializer<IoT::Datapoints::StringDatapointParams>
{
public:
	static void serialize(const std::string& name, const IoT::Datapoints::StringDatapointParams& value, Serializer& ser)
	{
	...
	static void serializeImpl(const IoT::Datapoints::StringDatapointParams& value, Serializer& ser)
	{
		using namespace std::string_literals;
		...
		TypeSerializer<Poco::Optional<std::string>>::serialize(REMOTING__NAMES[0], value.initialValue, ser);
	}
...
#endif // TypeSerializer_IoT_Datapoints_StringDatapointParams_INCLUDED
