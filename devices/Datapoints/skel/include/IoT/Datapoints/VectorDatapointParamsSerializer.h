//
// VectorDatapointParamsSerializer.h
//
// Package: Generated
...
#ifndef TypeSerializer_IoT_Datapoints_VectorDatapointParams_INCLUDED
#define TypeSerializer_IoT_Datapoints_VectorDatapointParams_INCLUDED
...
template <>
class TypeSerializer<IoT::Datapoints::VectorDatapointParams>
{
public:
	static void serialize(const std::string& name, const IoT::Datapoints::VectorDatapointParams& value, Serializer& ser)
	{
	...
	static void serializeImpl(const IoT::Datapoints::VectorDatapointParams& value, Serializer& ser)
	{
		using namespace std::string_literals;
		...
		TypeSerializer<Poco::Optional<std::vector<double>>>::serialize(REMOTING__NAMES[0], value.initialValue, ser);
	}
...
#endif // TypeSerializer_IoT_Datapoints_VectorDatapointParams_INCLUDED
