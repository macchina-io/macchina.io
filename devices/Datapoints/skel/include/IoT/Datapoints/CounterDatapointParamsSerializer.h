//
// CounterDatapointParamsSerializer.h
//
// Package: Generated
...
#ifndef TypeSerializer_IoT_Datapoints_CounterDatapointParams_INCLUDED
#define TypeSerializer_IoT_Datapoints_CounterDatapointParams_INCLUDED
...
template <>
class TypeSerializer<IoT::Datapoints::CounterDatapointParams>
{
public:
	static void serialize(const std::string& name, const IoT::Datapoints::CounterDatapointParams& value, Serializer& ser)
	{
	...
	static void serializeImpl(const IoT::Datapoints::CounterDatapointParams& value, Serializer& ser)
	{
		using namespace std::string_literals;
...
#endif // TypeSerializer_IoT_Datapoints_CounterDatapointParams_INCLUDED
