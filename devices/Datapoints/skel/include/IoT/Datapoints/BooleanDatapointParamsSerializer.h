//
// BooleanDatapointParamsSerializer.h
//
// Package: Generated
...
#ifndef TypeSerializer_IoT_Datapoints_BooleanDatapointParams_INCLUDED
#define TypeSerializer_IoT_Datapoints_BooleanDatapointParams_INCLUDED
...
template <>
class TypeSerializer<IoT::Datapoints::BooleanDatapointParams>
{
public:
	static void serialize(const std::string& name, const IoT::Datapoints::BooleanDatapointParams& value, Serializer& ser)
	{
	...
	static void serializeImpl(const IoT::Datapoints::BooleanDatapointParams& value, Serializer& ser)
	{
		using namespace std::string_literals;
		...
		TypeSerializer<Poco::Optional<bool>>::serialize(REMOTING__NAMES[0], value.initialValue, ser);
	}
...
#endif // TypeSerializer_IoT_Datapoints_BooleanDatapointParams_INCLUDED
