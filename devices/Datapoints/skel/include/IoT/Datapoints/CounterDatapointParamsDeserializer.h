//
// CounterDatapointParamsDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_IoT_Datapoints_CounterDatapointParams_INCLUDED
#define TypeDeserializer_IoT_Datapoints_CounterDatapointParams_INCLUDED
...
template <>
class TypeDeserializer<IoT::Datapoints::CounterDatapointParams>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, IoT::Datapoints::CounterDatapointParams& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, IoT::Datapoints::CounterDatapointParams& value)
	{
		using namespace std::string_literals;
		...
		TypeDeserializer<Poco::Optional<Poco::UInt64>>::deserialize(REMOTING__NAMES[0], false, deser, value.initialValue);
	}
...
#endif // TypeDeserializer_IoT_Datapoints_CounterDatapointParams_INCLUDED
