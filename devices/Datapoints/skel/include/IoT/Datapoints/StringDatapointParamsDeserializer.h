//
// StringDatapointParamsDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_IoT_Datapoints_StringDatapointParams_INCLUDED
#define TypeDeserializer_IoT_Datapoints_StringDatapointParams_INCLUDED
...
template <>
class TypeDeserializer<IoT::Datapoints::StringDatapointParams>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, IoT::Datapoints::StringDatapointParams& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, IoT::Datapoints::StringDatapointParams& value)
	{
		using namespace std::string_literals;
		...
		TypeDeserializer<Poco::Optional<std::string>>::deserialize(REMOTING__NAMES[0], false, deser, value.initialValue);
	}
...
#endif // TypeDeserializer_IoT_Datapoints_StringDatapointParams_INCLUDED
