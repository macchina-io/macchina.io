//
// EnumDatapointParamsSerializer.h
//
// Package: Generated
...
#ifndef TypeSerializer_IoT_Datapoints_EnumDatapointParams_INCLUDED
#define TypeSerializer_IoT_Datapoints_EnumDatapointParams_INCLUDED
...
template <>
class TypeSerializer<IoT::Datapoints::EnumDatapointParams>
{
public:
	static void serialize(const std::string& name, const IoT::Datapoints::EnumDatapointParams& value, Serializer& ser)
	{
	...
	static void serializeImpl(const IoT::Datapoints::EnumDatapointParams& value, Serializer& ser)
	{
		using namespace std::string_literals;
		...
		TypeSerializer<Poco::Optional < int > >::serialize(REMOTING__NAMES[0], value.initialValue, ser);
		TypeSerializer<std::vector < IoT::Devices::EnumValue > >::serialize(REMOTING__NAMES[1], value.values, ser);
	}
...
#endif // TypeSerializer_IoT_Datapoints_EnumDatapointParams_INCLUDED
