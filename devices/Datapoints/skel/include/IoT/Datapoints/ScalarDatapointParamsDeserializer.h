//
// ScalarDatapointParamsDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_IoT_Datapoints_ScalarDatapointParams_INCLUDED
#define TypeDeserializer_IoT_Datapoints_ScalarDatapointParams_INCLUDED
...
template <>
class TypeDeserializer<IoT::Datapoints::ScalarDatapointParams>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, IoT::Datapoints::ScalarDatapointParams& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, IoT::Datapoints::ScalarDatapointParams& value)
	{
		using namespace std::string_literals;
...
#endif // TypeDeserializer_IoT_Datapoints_ScalarDatapointParams_INCLUDED
