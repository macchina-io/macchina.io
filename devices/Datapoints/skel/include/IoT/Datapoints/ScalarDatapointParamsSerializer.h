...
public:
	...
	static void serializeImpl(const IoT::Datapoints::ScalarDatapointParams& value, Serializer& ser)
	{
		...
		static const std::string REMOTING__NAMES[] = {"physicalQuantity"s,"physicalUnit"s,"initialValue"s,""s};
		...
		TypeSerializer<Poco::Optional<double>>::serialize(REMOTING__NAMES[2], value.initialValue, ser);
	}
