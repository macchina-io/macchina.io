...
BarcodeReaderEventDispatcher::BarcodeReaderEventDispatcher(IBarcodeReader* pInterface, const Poco::RemotingNG::Identifiable::ObjectId& objectId, const std::string& protocol):
	Poco::RemotingNG::EventDispatcher(protocol),
	_objectId(objectId),
	_pInterface(pInterface)
{
	_pInterface->barcodeRead += Poco::delegate(this, &BarcodeReaderEventDispatcher::event__barcodeRead);
	_pInterface->statusChanged += Poco::delegate(this, &BarcodeReaderEventDispatcher::event__statusChanged);
}
