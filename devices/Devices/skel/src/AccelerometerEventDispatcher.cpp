...
AccelerometerEventDispatcher::AccelerometerEventDispatcher(IAccelerometer* pInterface, const Poco::RemotingNG::Identifiable::ObjectId& objectId, const std::string& protocol):
	Poco::RemotingNG::EventDispatcher(protocol),
	_objectId(objectId),
	_pInterface(pInterface)
{
	_pInterface->accelerationChanged += Poco::delegate(this, &AccelerometerEventDispatcher::event__accelerationChanged);
	_pInterface->statusChanged += Poco::delegate(this, &AccelerometerEventDispatcher::event__statusChanged);
}
