...
StringDatapointEventDispatcher::StringDatapointEventDispatcher(IStringDatapoint* pInterface, const Poco::RemotingNG::Identifiable::ObjectId& objectId, const std::string& protocol):
	Poco::RemotingNG::EventDispatcher(protocol),
	_objectId(objectId),
	_pInterface(pInterface)
{
	_pInterface->validated += Poco::delegate(this, &StringDatapointEventDispatcher::event__validated);
	_pInterface->valueChanged += Poco::delegate(this, &StringDatapointEventDispatcher::event__valueChanged);
	_pInterface->valueUpdated += Poco::delegate(this, &StringDatapointEventDispatcher::event__valueUpdated);
	_pInterface->invalidated += Poco::delegate(this, &StringDatapointEventDispatcher::event__invalidated);
	_pInterface->statusChanged += Poco::delegate(this, &StringDatapointEventDispatcher::event__statusChanged);
}
