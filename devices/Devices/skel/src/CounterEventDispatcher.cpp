...
CounterEventDispatcher::CounterEventDispatcher(ICounter* pInterface, const Poco::RemotingNG::Identifiable::ObjectId& objectId, const std::string& protocol):
	Poco::RemotingNG::EventDispatcher(protocol),
	_objectId(objectId),
	_pInterface(pInterface)
{
	_pInterface->countChanged += Poco::delegate(this, &CounterEventDispatcher::event__countChanged);
	_pInterface->statusChanged += Poco::delegate(this, &CounterEventDispatcher::event__statusChanged);
}
