//
// FlagsDatapointEventDispatcher.cpp
//
// Library: IoT/Devices
// Package: Generated
...
FlagsDatapointEventDispatcher::~FlagsDatapointEventDispatcher()
{
	try
	{
		_pInterface->validated -= Poco::delegate(this, &FlagsDatapointEventDispatcher::event__validated);
...
void FlagsDatapointEventDispatcher::event__invalidated(const void* pSender)
{
	if (pSender)
	{
		Poco::Clock now;
...
void FlagsDatapointEventDispatcher::event__statusChanged(const void* pSender, const IoT::Devices::DeviceStatusChange& data)
{
	if (pSender)
	{
		Poco::Clock now;
...
void FlagsDatapointEventDispatcher::event__invalidatedImpl(const std::string& subscriberURI)
{
...
void FlagsDatapointEventDispatcher::event__statusChangedImpl(const std::string& subscriberURI, const IoT::Devices::DeviceStatusChange& data)
{
	using namespace std::string_literals;
...
const std::string FlagsDatapointEventDispatcher::DEFAULT_NS("");
} // namespace Devices
} // namespace IoT
