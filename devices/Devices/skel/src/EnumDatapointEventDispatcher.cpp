...
EnumDatapointEventDispatcher::EnumDatapointEventDispatcher(EnumDatapointRemoteObject* pRemoteObject, const std::string& protocol):
	Poco::RemotingNG::EventDispatcher(protocol),
	_pRemoteObject(pRemoteObject)
{
	_pRemoteObject->validated += Poco::delegate(this, &EnumDatapointEventDispatcher::event__validated);
	_pRemoteObject->valueChanged += Poco::delegate(this, &EnumDatapointEventDispatcher::event__valueChanged);
	_pRemoteObject->valueUpdated += Poco::delegate(this, &EnumDatapointEventDispatcher::event__valueUpdated);
	_pRemoteObject->invalidated += Poco::delegate(this, &EnumDatapointEventDispatcher::event__invalidated);
	_pRemoteObject->statusChanged += Poco::delegate(this, &EnumDatapointEventDispatcher::event__statusChanged);
}
