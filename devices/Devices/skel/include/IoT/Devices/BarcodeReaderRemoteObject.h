...
inline Poco::Int16 BarcodeReaderRemoteObject::getPropertyInt16(const std::string& name) const
{
	return _pServiceObject->getPropertyInt16(name);
}


inline Poco::Int64 BarcodeReaderRemoteObject::getPropertyInt64(const std::string& name) const
{
...
inline Poco::Timestamp BarcodeReaderRemoteObject::getPropertyTimestamp(const std::string& name) const
{
...
inline void BarcodeReaderRemoteObject::setPropertyInt16(const std::string& name, Poco::Int16 value)
{
	_pServiceObject->setPropertyInt16(name, value);
}


inline void BarcodeReaderRemoteObject::setPropertyInt64(const std::string& name, Poco::Int64 value)
{
...
inline void BarcodeReaderRemoteObject::setPropertyTimestamp(const std::string& name, Poco::Timestamp value)
{
