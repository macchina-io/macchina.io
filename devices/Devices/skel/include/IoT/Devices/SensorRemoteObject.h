...
inline Poco::Int16 SensorRemoteObject::getPropertyInt16(const std::string& name) const
{
	return _pServiceObject->getPropertyInt16(name);
}


inline Poco::Int64 SensorRemoteObject::getPropertyInt64(const std::string& name) const
{
...
inline Poco::Timestamp SensorRemoteObject::getPropertyTimestamp(const std::string& name) const
{
...
inline void SensorRemoteObject::setPropertyInt16(const std::string& name, Poco::Int16 value)
{
	_pServiceObject->setPropertyInt16(name, value);
}


inline void SensorRemoteObject::setPropertyInt64(const std::string& name, Poco::Int64 value)
{
...
inline void SensorRemoteObject::setPropertyTimestamp(const std::string& name, Poco::Timestamp value)
{
...
inline void SensorRemoteObject::setValueChangedIsLessThanFilter(const std::string& subscriberURI, double limit)
{
...
inline void SensorRemoteObject::setValueChangedMinimumIntervalAndDeltaFilter(const std::string& subscriberURI, long milliseconds, double delta)
{
