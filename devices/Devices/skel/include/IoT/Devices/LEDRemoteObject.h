...
inline Poco::Int16 LEDRemoteObject::getPropertyInt16(const std::string& name) const
{
	return _pServiceObject->getPropertyInt16(name);
}


inline Poco::Int64 LEDRemoteObject::getPropertyInt64(const std::string& name) const
{
...
inline Poco::Timestamp LEDRemoteObject::getPropertyTimestamp(const std::string& name) const
{
...
inline void LEDRemoteObject::setPropertyInt16(const std::string& name, Poco::Int16 value)
{
	_pServiceObject->setPropertyInt16(name, value);
}


inline void LEDRemoteObject::setPropertyInt64(const std::string& name, Poco::Int64 value)
{
...
inline void LEDRemoteObject::setPropertyTimestamp(const std::string& name, Poco::Timestamp value)
{
