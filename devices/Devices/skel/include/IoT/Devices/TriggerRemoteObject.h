...
inline Poco::Int16 TriggerRemoteObject::getPropertyInt16(const std::string& name) const
{
	return _pServiceObject->getPropertyInt16(name);
}


inline Poco::Int64 TriggerRemoteObject::getPropertyInt64(const std::string& name) const
{
...
inline Poco::Timestamp TriggerRemoteObject::getPropertyTimestamp(const std::string& name) const
{
...
inline void TriggerRemoteObject::setPropertyInt16(const std::string& name, Poco::Int16 value)
{
	_pServiceObject->setPropertyInt16(name, value);
}


inline void TriggerRemoteObject::setPropertyInt64(const std::string& name, Poco::Int64 value)
{
...
inline void TriggerRemoteObject::setPropertyTimestamp(const std::string& name, Poco::Timestamp value)
{
