...
inline Poco::Int16 MagnetometerRemoteObject::getPropertyInt16(const std::string& name) const
{
	return _pServiceObject->getPropertyInt16(name);
}


inline Poco::Int64 MagnetometerRemoteObject::getPropertyInt64(const std::string& name) const
{
...
inline Poco::Timestamp MagnetometerRemoteObject::getPropertyTimestamp(const std::string& name) const
{
...
inline void MagnetometerRemoteObject::setPropertyInt16(const std::string& name, Poco::Int16 value)
{
	_pServiceObject->setPropertyInt16(name, value);
}


inline void MagnetometerRemoteObject::setPropertyInt64(const std::string& name, Poco::Int64 value)
{
...
inline void MagnetometerRemoteObject::setPropertyTimestamp(const std::string& name, Poco::Timestamp value)
{
