...
inline Poco::Int16 IORemoteObject::getPropertyInt16(const std::string& name) const
{
	return _pServiceObject->getPropertyInt16(name);
}


inline Poco::Int64 IORemoteObject::getPropertyInt64(const std::string& name) const
{
...
inline Poco::Timestamp IORemoteObject::getPropertyTimestamp(const std::string& name) const
{
...
inline void IORemoteObject::setPropertyInt16(const std::string& name, Poco::Int16 value)
{
	_pServiceObject->setPropertyInt16(name, value);
}


inline void IORemoteObject::setPropertyInt64(const std::string& name, Poco::Int64 value)
{
...
inline void IORemoteObject::setPropertyTimestamp(const std::string& name, Poco::Timestamp value)
{
