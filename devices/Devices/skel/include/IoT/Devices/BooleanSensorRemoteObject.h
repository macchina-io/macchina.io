...
inline Poco::Int16 BooleanSensorRemoteObject::getPropertyInt16(const std::string& name) const
{
	return _pServiceObject->getPropertyInt16(name);
}


inline Poco::Int64 BooleanSensorRemoteObject::getPropertyInt64(const std::string& name) const
{
...
inline Poco::Timestamp BooleanSensorRemoteObject::getPropertyTimestamp(const std::string& name) const
{
...
inline void BooleanSensorRemoteObject::setPropertyInt16(const std::string& name, Poco::Int16 value)
{
	_pServiceObject->setPropertyInt16(name, value);
}


inline void BooleanSensorRemoteObject::setPropertyInt64(const std::string& name, Poco::Int64 value)
{
...
inline void BooleanSensorRemoteObject::setPropertyTimestamp(const std::string& name, Poco::Timestamp value)
{
