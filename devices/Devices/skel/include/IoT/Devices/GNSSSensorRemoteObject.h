...
inline Poco::Int16 GNSSSensorRemoteObject::getPropertyInt16(const std::string& name) const
{
	return _pServiceObject->getPropertyInt16(name);
}


inline Poco::Int64 GNSSSensorRemoteObject::getPropertyInt64(const std::string& name) const
{
...
inline Poco::Timestamp GNSSSensorRemoteObject::getPropertyTimestamp(const std::string& name) const
{
...
inline void GNSSSensorRemoteObject::setPropertyInt16(const std::string& name, Poco::Int16 value)
{
	_pServiceObject->setPropertyInt16(name, value);
}


inline void GNSSSensorRemoteObject::setPropertyInt64(const std::string& name, Poco::Int64 value)
{
...
inline void GNSSSensorRemoteObject::setPropertyTimestamp(const std::string& name, Poco::Timestamp value)
{
