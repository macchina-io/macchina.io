...
inline Poco::Int16 DeviceRemoteObject::getPropertyInt16(const std::string& name) const
{
	return _pServiceObject->getPropertyInt16(name);
}


inline Poco::Int64 DeviceRemoteObject::getPropertyInt64(const std::string& name) const
{
...
inline Poco::Timestamp DeviceRemoteObject::getPropertyTimestamp(const std::string& name) const
{
...
inline void DeviceRemoteObject::setPropertyInt16(const std::string& name, Poco::Int16 value)
{
	_pServiceObject->setPropertyInt16(name, value);
}


inline void DeviceRemoteObject::setPropertyInt64(const std::string& name, Poco::Int64 value)
{
...
inline void DeviceRemoteObject::setPropertyTimestamp(const std::string& name, Poco::Timestamp value)
{
