...
inline Poco::Int16 GyroscopeRemoteObject::getPropertyInt16(const std::string& name) const
{
	return _pServiceObject->getPropertyInt16(name);
}


inline Poco::Int64 GyroscopeRemoteObject::getPropertyInt64(const std::string& name) const
{
...
inline Poco::Timestamp GyroscopeRemoteObject::getPropertyTimestamp(const std::string& name) const
{
...
inline void GyroscopeRemoteObject::setPropertyInt16(const std::string& name, Poco::Int16 value)
{
	_pServiceObject->setPropertyInt16(name, value);
}


inline void GyroscopeRemoteObject::setPropertyInt64(const std::string& name, Poco::Int64 value)
{
...
inline void GyroscopeRemoteObject::setPropertyTimestamp(const std::string& name, Poco::Timestamp value)
{
