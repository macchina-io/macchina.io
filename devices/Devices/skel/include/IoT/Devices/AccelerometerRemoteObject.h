...
inline Poco::Int16 AccelerometerRemoteObject::getPropertyInt16(const std::string& name) const
{
	return _pServiceObject->getPropertyInt16(name);
}


inline Poco::Int64 AccelerometerRemoteObject::getPropertyInt64(const std::string& name) const
{
...
inline Poco::Timestamp AccelerometerRemoteObject::getPropertyTimestamp(const std::string& name) const
{
...
inline void AccelerometerRemoteObject::setPropertyInt16(const std::string& name, Poco::Int16 value)
{
	_pServiceObject->setPropertyInt16(name, value);
}


inline void AccelerometerRemoteObject::setPropertyInt64(const std::string& name, Poco::Int64 value)
{
...
inline void AccelerometerRemoteObject::setPropertyTimestamp(const std::string& name, Poco::Timestamp value)
{
