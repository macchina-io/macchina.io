...
inline Poco::Int16 SerialDeviceRemoteObject::getPropertyInt16(const std::string& name) const
{
	return _pServiceObject->getPropertyInt16(name);
}


inline Poco::Int64 SerialDeviceRemoteObject::getPropertyInt64(const std::string& name) const
{
...
inline Poco::Timestamp SerialDeviceRemoteObject::getPropertyTimestamp(const std::string& name) const
{
...
inline void SerialDeviceRemoteObject::setPropertyInt16(const std::string& name, Poco::Int16 value)
{
	_pServiceObject->setPropertyInt16(name, value);
}


inline void SerialDeviceRemoteObject::setPropertyInt64(const std::string& name, Poco::Int64 value)
{
...
inline void SerialDeviceRemoteObject::setPropertyTimestamp(const std::string& name, Poco::Timestamp value)
{
