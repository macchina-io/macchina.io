...
inline Poco::Int16 SwitchRemoteObject::getPropertyInt16(const std::string& name) const
{
	return _pServiceObject->getPropertyInt16(name);
}


inline Poco::Int64 SwitchRemoteObject::getPropertyInt64(const std::string& name) const
{
...
inline Poco::Timestamp SwitchRemoteObject::getPropertyTimestamp(const std::string& name) const
{
...
inline void SwitchRemoteObject::setPropertyInt16(const std::string& name, Poco::Int16 value)
{
	_pServiceObject->setPropertyInt16(name, value);
}


inline void SwitchRemoteObject::setPropertyInt64(const std::string& name, Poco::Int64 value)
{
...
inline void SwitchRemoteObject::setPropertyTimestamp(const std::string& name, Poco::Timestamp value)
{
