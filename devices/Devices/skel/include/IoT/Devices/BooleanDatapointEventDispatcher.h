//
// BooleanDatapointEventDispatcher.h
//
// Library: IoT/Devices
// Package: Generated
...
#ifndef IoT_Devices_BooleanDatapointEventDispatcher_INCLUDED
...
class BooleanDatapointEventDispatcher: public Poco::RemotingNG::EventDispatcher
...
public:
	...
	void event__validated(const void* pSender, const bool& data);

	void event__valueChanged(const void* pSender, const bool& data);

	void event__valueUpdated(const void* pSender, const bool& data);
...
private:
	...
	void event__validatedImpl(const std::string& subscriberURI, const bool& data);

	void event__valueChangedImpl(const std::string& subscriberURI, const bool& data);
...
inline const Poco::RemotingNG::Identifiable::TypeId& BooleanDatapointEventDispatcher::remoting__typeId() const
{
...
#endif // IoT_Devices_BooleanDatapointEventDispatcher_INCLUDED
