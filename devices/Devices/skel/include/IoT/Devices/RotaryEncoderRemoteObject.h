...
inline Poco::Int16 RotaryEncoderRemoteObject::getPropertyInt16(const std::string& name) const
{
	return _pServiceObject->getPropertyInt16(name);
}


inline Poco::Int64 RotaryEncoderRemoteObject::getPropertyInt64(const std::string& name) const
{
...
inline Poco::Timestamp RotaryEncoderRemoteObject::getPropertyTimestamp(const std::string& name) const
{
...
inline void RotaryEncoderRemoteObject::setPropertyInt16(const std::string& name, Poco::Int16 value)
{
	_pServiceObject->setPropertyInt16(name, value);
}


inline void RotaryEncoderRemoteObject::setPropertyInt64(const std::string& name, Poco::Int64 value)
{
...
inline void RotaryEncoderRemoteObject::setPropertyTimestamp(const std::string& name, Poco::Timestamp value)
{
