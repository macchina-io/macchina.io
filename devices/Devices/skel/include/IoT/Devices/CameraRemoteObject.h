...
inline Poco::Int16 CameraRemoteObject::getPropertyInt16(const std::string& name) const
{
	return _pServiceObject->getPropertyInt16(name);
}


inline Poco::Int64 CameraRemoteObject::getPropertyInt64(const std::string& name) const
{
...
inline Poco::Timestamp CameraRemoteObject::getPropertyTimestamp(const std::string& name) const
{
...
inline void CameraRemoteObject::setPropertyInt16(const std::string& name, Poco::Int16 value)
{
	_pServiceObject->setPropertyInt16(name, value);
}


inline void CameraRemoteObject::setPropertyInt64(const std::string& name, Poco::Int64 value)
{
...
inline void CameraRemoteObject::setPropertyTimestamp(const std::string& name, Poco::Timestamp value)
{
