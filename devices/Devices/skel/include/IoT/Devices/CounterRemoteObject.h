...
inline Poco::Int16 CounterRemoteObject::getPropertyInt16(const std::string& name) const
{
	return _pServiceObject->getPropertyInt16(name);
}


inline Poco::Int64 CounterRemoteObject::getPropertyInt64(const std::string& name) const
{
...
inline Poco::Timestamp CounterRemoteObject::getPropertyTimestamp(const std::string& name) const
{
...
inline void CounterRemoteObject::setPropertyInt16(const std::string& name, Poco::Int16 value)
{
	_pServiceObject->setPropertyInt16(name, value);
}


inline void CounterRemoteObject::setPropertyInt64(const std::string& name, Poco::Int64 value)
{
...
inline void CounterRemoteObject::setPropertyTimestamp(const std::string& name, Poco::Timestamp value)
{
