...
LEDEventDispatcher::LEDEventDispatcher(LEDRemoteObject* pRemoteObject, const std::string& protocol):
	Poco::RemotingNG::EventDispatcher(protocol),
	_pRemoteObject(pRemoteObject)
{
	_pRemoteObject->statusChanged += Poco::delegate(this, &LEDEventDispatcher::event__statusChanged);
}
