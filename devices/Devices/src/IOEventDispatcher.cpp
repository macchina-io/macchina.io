...
void IOEventDispatcher::event__stateChanged(const void* pSender, const Poco::UInt32& data)
{
	if (pSender)
	{
		Poco::Timestamp now;
...
void IOEventDispatcher::event__stateChangedImpl(const std::string& subscriberURI, const Poco::UInt32& data)
{
