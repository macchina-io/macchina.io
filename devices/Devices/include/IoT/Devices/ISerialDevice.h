...
class ISerialDevice: public IoT::Devices::IDevice
	...
	/// polling (blocking) mode (default) and callback mode.
	///
	...
	///
	/// In callback mode the class will start a thread that polls
	...
	///
	/// Clients of the class can switch between polling and callback
	/// mode by enabling or disabling the "callback" feature:
	///
	///     setFeature("callback", true);
{
public:
