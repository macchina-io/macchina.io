...
#ifndef IoT_Devices_LEDStub_INCLUDED
#define IoT_Devices_LEDStub_INCLUDED
...
class LEDStub: public IoT::Devices::LEDRemoteObject
...
{
public:
	typedef Poco::AutoPtr<LEDStub> Ptr;

	LEDStub(const Poco::RemotingNG::Identifiable::ObjectId& oid, Poco::SharedPtr<IoT::Devices::LED> pServiceObject);
		/// Creates a LEDStub.

	virtual ~LEDStub();
		/// Destroys the LEDStub.
...
inline void LEDStub::blink(int onMilliseconds, int offMilliseconds)
{
	_pServiceObject->blink(onMilliseconds, offMilliseconds);
}


inline double LEDStub::getBrightness() const
{
	return _pServiceObject->getBrightness();
}


inline bool LEDStub::getFeature(const std::string& name) const
{
	return _pServiceObject->getFeature(name);
}


inline bool LEDStub::getPropertyBool(const std::string& name) const
{
	return _pServiceObject->getPropertyBool(name);
}


inline double LEDStub::getPropertyDouble(const std::string& name) const
{
	return _pServiceObject->getPropertyDouble(name);
}


inline int LEDStub::getPropertyInt(const std::string& name) const
{
	return _pServiceObject->getPropertyInt(name);
}


inline std::string LEDStub::getPropertyString(const std::string& name) const
{
	return _pServiceObject->getPropertyString(name);
}


inline bool LEDStub::hasFeature(const std::string& name) const
{
	return _pServiceObject->hasFeature(name);
}


inline bool LEDStub::hasProperty(const std::string& name) const
{
	return _pServiceObject->hasProperty(name);
}


inline void LEDStub::off()
{
	_pServiceObject->off();
}


inline void LEDStub::on()
{
	_pServiceObject->on();
}


inline const Poco::RemotingNG::Identifiable::TypeId& LEDStub::remoting__typeId() const
{
	return ILED::remoting__typeId();
}


inline void LEDStub::setBrightness(double brightness)
{
	_pServiceObject->setBrightness(brightness);
}


inline void LEDStub::setFeature(const std::string& name, bool enable)
{
	_pServiceObject->setFeature(name, enable);
}


inline void LEDStub::setPropertyBool(const std::string& name, bool value)
{
	_pServiceObject->setPropertyBool(name, value);
}


inline void LEDStub::setPropertyDouble(const std::string& name, double value)
{
	_pServiceObject->setPropertyDouble(name, value);
}


inline void LEDStub::setPropertyInt(const std::string& name, int value)
{
	_pServiceObject->setPropertyInt(name, value);
}


inline void LEDStub::setPropertyString(const std::string& name, const std::string& value)
{
...
#endif // IoT_Devices_LEDStub_INCLUDED
