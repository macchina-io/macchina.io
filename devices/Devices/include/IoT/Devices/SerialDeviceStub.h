...
#ifndef IoT_Devices_SerialDeviceStub_INCLUDED
#define IoT_Devices_SerialDeviceStub_INCLUDED
...
class SerialDeviceStub: public IoT::Devices::SerialDeviceRemoteObject
...
{
public:
	typedef Poco::AutoPtr<SerialDeviceStub> Ptr;

	SerialDeviceStub(const Poco::RemotingNG::Identifiable::ObjectId& oid, Poco::SharedPtr<IoT::Devices::SerialDevice> pServiceObject);
		/// Creates a SerialDeviceStub.

	virtual ~SerialDeviceStub();
		/// Destroys the SerialDeviceStub.
...
inline int SerialDeviceStub::available() const
{
	return _pServiceObject->available();
}


inline bool SerialDeviceStub::getFeature(const std::string& name) const
{
	return _pServiceObject->getFeature(name);
}


inline bool SerialDeviceStub::getPropertyBool(const std::string& name) const
{
	return _pServiceObject->getPropertyBool(name);
}


inline double SerialDeviceStub::getPropertyDouble(const std::string& name) const
{
	return _pServiceObject->getPropertyDouble(name);
}


inline int SerialDeviceStub::getPropertyInt(const std::string& name) const
{
	return _pServiceObject->getPropertyInt(name);
}


inline std::string SerialDeviceStub::getPropertyString(const std::string& name) const
{
	return _pServiceObject->getPropertyString(name);
}


inline bool SerialDeviceStub::getRTS() const
{
	return _pServiceObject->getRTS();
}


inline bool SerialDeviceStub::hasFeature(const std::string& name) const
{
	return _pServiceObject->hasFeature(name);
}


inline bool SerialDeviceStub::hasProperty(const std::string& name) const
{
	return _pServiceObject->hasProperty(name);
}


inline bool SerialDeviceStub::poll(double timeout)
{
	return _pServiceObject->poll(timeout);
}


inline Poco::UInt8 SerialDeviceStub::readByte()
{
	return _pServiceObject->readByte();
}


inline std::string SerialDeviceStub::readLine(const std::string& delimiters, double timeout)
{
	return _pServiceObject->readLine(delimiters, timeout);
}


inline std::string SerialDeviceStub::readString()
{
	return _pServiceObject->readString();
}


inline void SerialDeviceStub::reconfigure(int baudRate, const std::string& parameters, const std::string& flowControl)
{
	_pServiceObject->reconfigure(baudRate, parameters, flowControl);
}


inline const Poco::RemotingNG::Identifiable::TypeId& SerialDeviceStub::remoting__typeId() const
{
	return ISerialDevice::remoting__typeId();
}


inline void SerialDeviceStub::setFeature(const std::string& name, bool enable)
{
	_pServiceObject->setFeature(name, enable);
}


inline void SerialDeviceStub::setPropertyBool(const std::string& name, bool value)
{
	_pServiceObject->setPropertyBool(name, value);
}


inline void SerialDeviceStub::setPropertyDouble(const std::string& name, double value)
{
	_pServiceObject->setPropertyDouble(name, value);
}


inline void SerialDeviceStub::setPropertyInt(const std::string& name, int value)
{
	_pServiceObject->setPropertyInt(name, value);
}


inline void SerialDeviceStub::setPropertyString(const std::string& name, const std::string& value)
{
	_pServiceObject->setPropertyString(name, value);
}


inline void SerialDeviceStub::setRTS(bool status)
{
	_pServiceObject->setRTS(status);
}


inline void SerialDeviceStub::writeByte(Poco::UInt8 byte)
{
	_pServiceObject->writeByte(byte);
}


inline void SerialDeviceStub::writeString(const std::string& data)
{
...
#endif // IoT_Devices_SerialDeviceStub_INCLUDED
